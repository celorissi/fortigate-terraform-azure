# 📘 Playbook Azure CLI – Deploy Manual do FortiGate
...
Observação: a criação da VM pode variar conforme SKU e plano Fortinet. Aqui está o fluxo básico.
